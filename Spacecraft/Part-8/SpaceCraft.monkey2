'Part 8 - Fix the camera on the player to scroll around the map, with parallax
'1) Have the game origin fix itself to the player.
'2) Create a parallax class to repeat a background pattern for a parallax effect.
...
Class SpaceCraft Extends Window
	...
	Method OnRender( canvas:Canvas ) Override
		...
		canvas.DrawOval(Map.NodeXToWorld(x) - 5 - Origin.x,Map.NodeYToWorld(y) - 5 - Origin.y, 10, 10)
