...
Class SpaceCraft Extends Window
	...
	Method OnRender( canvas:Canvas ) Override
		...
		canvas.TextureFilter = TextureFilter.Linear
		...
		canvas.DrawOval((Map.NodeXToWorld(x) - 5 - Origin.x) * ScreenScale.x, (Map.NodeYToWorld(y) - 5 - Origin.y) * ScreenScale.y, 10, 10)
...
'To do this we use a "Matrix", thankfully Monkey 2 makes that easy - just create a matrix, use the Rotate method of
