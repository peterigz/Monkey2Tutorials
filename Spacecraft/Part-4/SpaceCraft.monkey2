...
Class SpaceCraft Extends Window
	...
	Method InitGame()
		...
		Player = New Player(Self, 400, 200)
	...
	Method OnRender( canvas:Canvas ) Override
		...
		'Draw the test tiles to make sure that they have loaded in properly
		Local x:Float
		For Local i:=Eachin TestTileSet.Tiles
			canvas.DrawImage(i.Image, x*32, 0)
			x+=1
		Next
	...
	Method OnUpdate()
		...
		cpSpaceBBQuery(Space, cpBBNew(0, 0, Width, Height), spacefilter, UpdateSpaceCallBack, Varptr Me)
